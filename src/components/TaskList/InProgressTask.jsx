...
const InProgressTask = ({ data, onAddSubTask, onUpdateStatus }) => {
  const subTasks = Array.isArray(data?.subTasks) ? data.subTasks : []

  return (
    <div className="relative w-full sm:w-72 md:w-80 lg:w-72 flex-shrink-0 min-h-[22rem] rounded-2xl bg-gradient-to-br from-blue-500/95 to-emerald-400/95 text-white shadow-xl overflow-hidden snap-start">
