...
const CompleteTask = ({ data, onAddSubTask, onUpdateStatus }) => {
  const subTasks = Array.isArray(data?.subTasks) ? data.subTasks : []

  return (
    <div className="relative w-full sm:w-72 md:w-80 lg:w-72 flex-shrink-0 min-h-[22rem] rounded-2xl bg-gradient-to-br from-emerald-500/95 to-emerald-400/95 text-white shadow-xl overflow-hidden snap-start">
      ...
      <div className="px-5 pb-5 pt-4 sm:pt-6">
        ...
        <SubTaskSection subTasks={subTasks} onAddSubTask={onAddSubTask} />
      </div>
    </div>
  )
}
